...
parser.add_argument('--max_length_of_trajectory', default=5000, type=int) # length of game
...
def main():
    ...
    for episode in range(args.max_episode):
        ...
        while True:
            ...
            if net.memory_counter >= args.max_length_of_trajectory or done:
                net.learn()
            ...
            state = next_state
    plt.plot(range(args.max_episodes),episode_reward,'k-')
